...
export default function DashboardMetrics({ userRole, userId }: DashboardMetricsProps) {
  ...
  const fetchTrainingStats = async () => {
    try {
      ...
      const response = await fetch(`/api/training/employee/${userId}`)
  ...
  const handleNavigateToTrainings = () => {
    router.push('/dashboard/training?filter=my-courses')
  }
